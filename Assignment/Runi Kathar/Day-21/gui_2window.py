...
img_obj1 = ImageTk.PhotoImage(Image.open('goodmorning1.jpg').resize((300,205), Image.LANCZOS))
img_obj2 = ImageTk.PhotoImage(Image.open('goodmorning2.jpg').resize((300,205), Image.LANCZOS))
img_obj3 = ImageTk.PhotoImage(Image.open('goodmorning3.jpg').resize((300,205), Image.LANCZOS))
img_obj4 = ImageTk.PhotoImage(Image.open('goodmorning4.jpg').resize((300,205), Image.LANCZOS))
img_obj5 = ImageTk.PhotoImage(Image.open('goodmorning5.jpg').resize((300,205), Image.LANCZOS))
img_obj6 = ImageTk.PhotoImage(Image.open('goodmorning6.jpg').resize((300,205), Image.LANCZOS))
img_obj7 = ImageTk.PhotoImage(Image.open('goodmorning7.jpg').resize((300,205), Image.LANCZOS))
...
def window():
	...
	new_window.iconbitmap('bird.ico')
